...
- **Light theme (fixed):** background `#FAFAF8`, cards `#FFFFFF` with `shadow-sm`, foreground `#1A1A1A`, muted `#6B7280`, border `#E5E7EB`, accent green `#16A34A`. Rounded corners `rounded-2xl` on cards. Badge colors: green `bg-[#dcfce7] text-[#15803d]`, yellow `bg-[#fef3c7] text-[#B45309]`, red `bg-[#fee2e2] text-[#DC2626]`.
