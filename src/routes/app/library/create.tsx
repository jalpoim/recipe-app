    ...
    <div className="min-h-screen bg-[#FAFAF8] pb-24">
      ...
      <div className="sticky top-0 z-10 bg-[#FAFAF8] border-b border-[#F0F0EE]">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={() => navigate({ to: '/app/library', search: { q: '', proteins: [], maxCal: undefined, maxTime: undefined, tags: [], ingredients: [], sort: 'pcal' as const, modes: [], category: undefined, categorySort: 'popular' as const } })}
